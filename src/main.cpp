...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 4; //4 days
...
const string strMessageMagic = "PRO Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PRO", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The Last Man to Beat Floyd Mayweather Jr. Still Regrets It";
        CTransaction txNew;
        txNew.nTime = 1428070225;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1428070225;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1834650;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x8e6919de7e086aae28d7c0edd82ac21f4f32afaf91dd28366149b2f735ff52b4"));
        block.print();
